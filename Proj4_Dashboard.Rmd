...
-----------------------------------------------------------------------
```{r}
h1(strong("Map of Baltimore neighborhoods with 2022 Healthy Food Priority Levels"), style = "font-size:30px;")
```
...
```{r}
h1(strong("Map of Baltimore neighborhoods with 2018 Healthy Food Priority Levels"), style = "font-size:30px;")
```
...
-----------------------------------------------------------------------
```{r}
h1(strong("Exploring the neighborhoods which experienced a change in Healthy Food Priority Level"), style = "font-size:30px;")
```

```{r}
h2(strong("Map of Baltimore neighborhoods which changed priority level between 2018 and 2022"), style = "font-size:30px;")
```
...
```{r}
h2(strong("Dumbbell plot of Baltimore neighborhood names which changed priority level between 2018 and 2022"), style = "font-size:30px;")
```
