...
```{r}
h1(strong("Map of Baltimore Neighborhoods with 2022 Healthy Food Priority Levels"), style = "font-size:25px;")
```
...
```{r}
h1(strong("Map of Baltimore Neighborhoods with 2018 Healthy Food Priority Levels"), style = "font-size:25px;")
```
...
```{r}
h1(strong("Exploring the Neighborhoods Which Experienced a Change in Healthy Food Priority Level"), style = "font-size:25px;")
```

```{r}
h2(strong("Map of Baltimore Neighborhoods Which Changed Priority Level Between 2018 and 2022"), style = "font-size:25px;")
```
